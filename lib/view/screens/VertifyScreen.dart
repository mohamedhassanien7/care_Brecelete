      ...
      body: Column(
        ...
        children: [
          ...
          Row(
            children: [
              SizedBox(width: 20,),
              Text('Check your email', style: TextStyle(fontWeight: FontWeight.bold , fontSize: 20),)
            ],
          ),
          SizedBox(height: 15,),
          Row(
            children: [
              SizedBox(width: 22,),
            Text('We sent a reset link to', style: TextStyle(fontSize: 17),),
              Text(' contact@dscode...com', style: TextStyle(fontSize: 17, color: Colors.grey),),
            ],),
          Row(
            children: [
              SizedBox(width: 22,),
            Text('enter 4 digit code that mentioned in the email',style: TextStyle(fontSize: 17),)
          ],),
              ...
              SizedBox(width:300,
                ...
                child: Expanded(
                  child: ElevatedButton(
                      ...
                      child: Text("Verify Code", style: TextStyle(color: Colors.white, fontSize: 24),)),
                ),
              ),
            ],
          ),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Text('Haven’t got the email yet?',style: TextStyle(fontSize: 15),),
              InkWell(
                  onTap: (){

                  },
                  child: Text('Resend email' , style: TextStyle(fontSize: 15, color: Color(0xFF9177DC),decoration: TextDecoration.underline,decorationColor: Color(0xFF9177DC)))),
            ],
          )
