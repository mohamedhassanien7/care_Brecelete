        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                SizedBox(width: 20,),
                Text('verify your email', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),),
              ],
            ),
            SizedBox(height: 5,),
            Row(
              children: [
                SizedBox(width: 20,),
                Text('please enter the 4 digit code sent to \n yourmail@example.com ', style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15, color: Colors.grey),),
              ],
            ),
            Form(
              key: formKey,
            ...
            Center(child: InkWell(
                ...
                child: Text('Resend code',style: TextStyle(fontSize: 20, color: Color(0xFF9177DC)),))),
                ...
                SizedBox(width:300,
                  ...
                  child: Expanded(
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          Navigator.of(context).pushNamed(HomeScreen3.routeName);
                        },
