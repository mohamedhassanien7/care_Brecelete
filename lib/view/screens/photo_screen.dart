        ...
        body: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
                ...
                children: [
                  CustomTextField(hintText: 'Clinic address', textInputType: TextInputType.text,color: Colors.white,),
                  CustomTextField(hintText: 'Specialization', textInputType: TextInputType.text, color: Colors.white,),
                  Row(
                        ...
                        child: Center(
                          child: ElevatedButton(
                              style: ElevatedButton.styleFrom(
                                  ...
                                  backgroundColor: Color(MyTheme.bGround_Button)),
                              onPressed: () {
                                Navigator.of(context).pushNamed(FaceRecognition2.routeName);
                              },
                              child: Text(
                                'Next',
                                style: TextStyle(
